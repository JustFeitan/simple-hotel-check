import {AriaAttributes, DetailedHTMLProps, FC, HTMLAttributes} from 'react';
interface SvgIconProps extends DetailedHTMLProps<HTMLAttributes<SVGSVGElement>, SVGSVGElement>, AriaAttributes{

}
const HeartIcon: FC<SvgIconProps> = (props) => {
    return (
        <svg width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path
                ...
                fill="white" stroke="#C4C4C4" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    );
};
